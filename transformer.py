#taken from https://github.com/kevinzakka/spatial-transformer-network/edit/master/stn/transformer.py
#see https://arxiv.org/pdf/1506.02025.pdf

import tensorflow as tf


def spatial_transformer_network(input_fmap, theta, out_dims=None, restricted_theta=False, **kwargs):
    """
    ...
    if restricted_theta:
        ...
        theta_full[0] = theta[:,0]
        theta_full[2] = theta[:,1]
        theta_full[4] = theta[:,2]
